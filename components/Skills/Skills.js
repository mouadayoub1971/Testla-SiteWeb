      ...
      <div className="section-container py-16 flex flex-col justify-center">
        ...
        <div className="flex flex-col skills-wrapper">
          <div className="flex flex-col">
            ...
            Je prends la responsabilité de concevoir et de mettre en place des systèmes industriels efficaces, évolutifs et fiables, en m’appuyant sur les principes du génie industriel et les outils modernes d’optimisation des performances.{" "}
            </h2>
          </div>
          <div className="mt-10">
